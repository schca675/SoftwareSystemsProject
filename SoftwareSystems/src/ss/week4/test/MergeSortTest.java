...
public class MergeSortTest {
    ...
    public void testMergesortSingleItem() {
        List<Integer> sequence = new ArrayList<Integer>(Arrays.asList(1));
        MergeSort.mergesort(sequence);
    ...
    public void testMergesortSortedList() {
        List<Integer> sequence = new ArrayList<Integer>(Arrays.asList(1, 2, 3, 4, 5));
        MergeSort.mergesort(sequence);
        assertEquals(sequence, Arrays.asList(1, 2, 3, 4, 5));

        sequence = new ArrayList<Integer>(Arrays.asList(1, 2, 3, 4, 5, 6));
        MergeSort.mergesort(sequence);
    ...
    public void testMergesortUnsortedList() {
        List<Integer> sequence = new ArrayList<Integer>(Arrays.asList(3, 2, 1, 5, 4));
        MergeSort.mergesort(sequence);
        assertEquals(sequence, Arrays.asList(1, 2, 3, 4, 5));

        sequence = new ArrayList<Integer>(Arrays.asList(3, 2, 1, 6, 5, 4));
        MergeSort.mergesort(sequence);
        assertEquals(sequence, Arrays.asList(1, 2, 3, 4, 5, 6));
    }
}
